...
<body>
  <div class="navbar-fixed">
    <nav class="teal lighten-1" role="navigation">
      <div class="nav-wrapper container"><a id="logo-container" href="index.php" class="brand-logo">CRIJ - 3EME ADAM</a>
        <ul class="right hide-on-med-and-down">
          ...
          <!-- Modal Trigger -->
          <li><a href="publier.php">Ajouter</a></li>
          <li class="enable-notifications"><a> <i class="material-icons">notifications</i></a></li>
          <!-- <li><a data-target="connexion" class="modal-trigger" data-modelClicked>Publier</a></li> -->
      ...
      <a href="#name"><span class="blue-text name">Inscription</span></a> -->
          ...
          <li><a href="publier.php"> <i class="material-icons">screen_share</i> Ajouter</a></li>
          <!-- <li><a href="#" onclick="javascript:developpement();"> <i class="material-icons">hotel</i> A Louer</a></li> -->
          <!-- <li data-modelClicked2><a data-target="connexion" class="modal-trigger" > <i class="material-icons">screen_share</i> Publier</a></li> -->
